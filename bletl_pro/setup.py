...
setuptools.setup(name = __packagename__,
        ...
        version=__version__,
        description='Package for parsing and transforming BioLector Pro raw data.',
        url='https://gitlab.fz-juelich.de/IBG-1/biopro/bletl',
        download_url = 'https://gitlab.fz-juelich.de/IBG-1/biopro/bletl/tarball/%s' % __version__,
